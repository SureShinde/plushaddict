...
class ListPost extends \FishPig\WordPress\Block\Post
{
	...
	public function getLimitedPosts($value)
	{
		$this->_postCollection = $this->_factory->getFactory('Post')->create()->getCollection()->addIsPublishedFilter()->addPostTypeFilter('post')->setPageSize($value);
